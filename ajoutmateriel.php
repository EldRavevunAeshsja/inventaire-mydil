...
<head>
  <meta charset="utf-8">
  <title>MyDIL - Ajout matériel</title>
  <link rel="stylesheet" href="style/ajoutmateriel.css">
</head>
...
<body>
  ...
  <div id="form">
    ...
    <p id="form_desc">Remplissez ce formulaire afin de rajouter du matériel azeazeazeaze</br>
      ...
      <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
        ...
        <textarea id="form_champ_desc" name="desc" placeholder="Entrez une description pour l'objet" required="" rows="8" cols="36"><?php if(isset($_POST['desc'])){echo htmlspecialchars($_POST['desc']);}?></textarea> <br/>
        ...
        <select class="form_champ" name="subcategory">
          <option value="null" <?php if (isset($_POST['subcategory']) && $_POST['subcategory'] == "null"){echo "selected";} ?>>--Séléctionnez une catégorie--
